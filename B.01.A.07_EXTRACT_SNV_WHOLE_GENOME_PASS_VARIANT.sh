...
$CORE_PATH/$PROJECT/SCRIPTS/B.01.A.07.A.01_TI_TV_WHOLE_GENOME_PASS.sh $1 $2 $3 $4 $5 $6
...
$CORE_PATH/$PROJECT/SCRIPTS/B.01.A.07.A.02_TI_TV_WHOLE_GENOME_KNOWN.sh $1 $2 $3 $4 $5 $6
...
$CORE_PATH/$PROJECT/SCRIPTS/B.01.A.07.A.03_TI_TV_WHOLE_GENOME_NOVEL.sh $1 $2 $3 $4 $5 $6
