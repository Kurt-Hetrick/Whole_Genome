...
-T VariantAnnotator \
-R $REF_GENOME \
--variant $CORE_PATH/$PROJECT/$DNA_HASH_ADDRESS/$MDNA_HASH_ADDRESS/VQSR/all/variants.all.vcf.gz \
-L $CORE_PATH/$PROJECT/$DNA_HASH_ADDRESS/$MDNA_HASH_ADDRESS/VQSR/all/variants.all.vcf.gz \
-A GCContent \
-A VariantType \
...
$CORE_PATH/$PROJECT/SCRIPTS/B.01.A.01_INDEX_VCF.sh $1 $2 $3 $4 $5 $6
...
$CORE_PATH/$PROJECT/SCRIPTS/B.01.A.02_EXTRACT_VCF_CODING.sh $1 $2 $3 $4 $5 $6
...
$CORE_PATH/$PROJECT/SCRIPTS/B.01.A.03_EXTRACT_VCF_WHOLE_GENOME_PASS_VARIANT.sh $1 $2 $3 $4 $5 $6
...
$CORE_PATH/$PROJECT/SCRIPTS/B.01.A.04_EXTRACT_VCF_CODING_PASS_VARIANT.sh $1 $2 $3 $4 $5 $6
...
$CORE_PATH/$PROJECT/SCRIPTS/B.01.A.05_EXTRACT_SNV_WHOLE_GENOME.sh $1 $2 $3 $4 $5 $6
...
$CORE_PATH/$PROJECT/SCRIPTS/B.01.A.06_EXTRACT_SNV_CODING.sh $1 $2 $3 $4 $5 $6
...
$CORE_PATH/$PROJECT/SCRIPTS/B.01.A.07_EXTRACT_SNV_WHOLE_GENOME_PASS_VARIANT.sh $1 $2 $3 $4 $5 $6
...
$CORE_PATH/$PROJECT/SCRIPTS/B.01.A.08_EXTRACT_SNV_CODING_PASS_VARIANT.sh $1 $2 $3 $4 $5 $6
...
$CORE_PATH/$PROJECT/SCRIPTS/B.01.A.09_EXTRACT_INDEL_WHOLE_GENOME.sh $1 $2 $3 $4 $5 $6
...
$CORE_PATH/$PROJECT/SCRIPTS/B.01.A.10_EXTRACT_INDEL_CODING.sh $1 $2 $3 $4 $5 $6
...
$CORE_PATH/$PROJECT/SCRIPTS/B.01.A.11_EXTRACT_INDEL_WHOLE_GENOME_PASS_VARIANT.sh $1 $2 $3 $4 $5 $6
...
$CORE_PATH/$PROJECT/SCRIPTS/B.01.A.12_EXTRACT_INDEL_CODING_PASS_VARIANT.sh $1 $2 $3 $4 $5 $6
